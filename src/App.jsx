...
const FRASES = [
  { label: "Guia certo", texto: "O mercado de consórcio é cheio de opções.\n\nMas só quem tem o guia certo chega no destino sem perder tempo ou dinheiro.", legenda: "O consórcio certo começa com o guia certo. 🧭\n\nSe você já pensou em ter seu imóvel ou carro próprio mas não sabe por onde começar, me chama no WhatsApp e vamos montar seu plano. 📲\n\n#consorcio #consorciodeImovel #planejamentofinanceiro #patrimonio" },
  { label: "Patrimônio", texto: "Patrimônio não cai do céu.\n\nEle é construído, parcela a parcela, com estratégia e consistência.", legenda: "Patrimônio se constrói, não se ganha de sorte. 🏗️\n\nQuer saber como o consórcio pode te ajudar a chegar lá mais rápido? Manda mensagem que eu te explico. 📲\n\n#consorcio #patrimonio #investimento #planejamentofinanceiro" },
  { label: "Sem juros", texto: "Juros altos não precisam ser o seu caminho.\n\nConsórcio é planejamento inteligente para quem quer crescer de verdade.", legenda: "Cansado de pagar juros altos? Existe um jeito mais inteligente de conquistar o que você quer. 💡\n\nVem comigo entender como funciona o consórcio. Simulação gratuita no WhatsApp. 📲\n\n#consorcio #semjuros #planejamentofinanceiro #investimento" },
  { label: "Comece hoje", texto: "A melhor hora de começar a investir em patrimônio foi ontem.\n\nA segunda melhor hora é hoje.", legenda: "Não dá pra voltar no tempo, mas dá pra começar agora. ⏰\n\nVamos simular o seu plano de consórcio hoje mesmo? Só clicar no link do WhatsApp na bio. 📲\n\n#consorcio #comeceagora #patrimonio #planejamentofinanceiro" },
  { label: "Estratégia", texto: "Não é sorte. Não é herança.\n\nÉ estratégia. É consistência. É consórcio.", legenda: "Quem tem patrimônio hoje, planejou ontem. 📊\n\nSe você quer fazer parte desse grupo, bora conversar — simulação sem compromisso pelo WhatsApp. 📲\n\n#consorcio #estrategia #planejamentofinanceiro #patrimonio" },
  { label: "4 anos", texto: "Em 4 anos ajudando pessoas com consórcio, aprendi uma coisa:\n\nQuem planeja antes, conquista mais rápido.", legenda: "4 anos vendo de perto como o planejamento certo muda a história de quem decide agir. 📈\n\nQuer ser o próximo? Me chama no WhatsApp. 📲\n\n#consorcio #experiencia #planejamentofinanceiro #consultordeconsorcio" },
  { label: "Sonho perto", texto: "Seu imóvel dos sonhos está mais perto do que você imagina.\n\nSimule agora e descubra como começar.", legenda: "O imóvel ou carro que você sonha pode estar mais perto do que você pensa. 🏡🚗\n\nSimule agora comigo, sem compromisso — só clicar no WhatsApp. 📲\n\n#consorcio #imoveis #carros #sonho" },
  { label: "Longo prazo", texto: "Consórcio não é para quem tem pressa.\n\nÉ para quem quer chegar longe.", legenda: "Consórcio é para quem pensa grande e a longo prazo. 🎯\n\nSe esse é o seu perfil, vamos conversar sobre o seu plano? Link na bio. 📲\n\n#consorcio #longoprazo #planejamentofinanceiro #patrimonio" },
  { label: "Simples", texto: "Muita gente acha que consórcio é complicado.\n\nNa verdade, o que falta é alguém que explique do jeito certo.", legenda: "Consórcio não é complicado — só precisa de quem explique direito. 🗣️\n\nManda sua dúvida no WhatsApp que eu te ajudo a entender tudo sem enrolação. 📲\n\n#consorcio #duvidas #planejamentofinanceiro #explicafacil" },
  { label: "Bom plano", texto: "Você não precisa esperar ter tudo para começar.\n\nPrecisa apenas de um bom plano — e alguém que te ajude a executar.", legenda: "Você não precisa ter tudo resolvido pra começar. Precisa de um bom plano. 📋\n\nEu te ajudo a montar o seu — simulação gratuita pelo WhatsApp. 📲\n\n#consorcio #planejamentofinanceiro #patrimonio #comecarbem" },
];
...
const TEMAS_IA = [
  "Motivacional sobre conquistas",
  "Sobre consórcio e patrimônio",
  "Mitos sobre consórcio",
  "Disciplina financeira",
  "Chamada para simulação",
];

function gerarFraseIA(tema) {
  const banco = {
    "Motivacional sobre conquistas": [
      "Grandes conquistas começam com pequenas decisões.\n\nHoje pode ser o dia em que você decide construir algo maior.",
      "Ninguém constrói patrimônio por acaso.\n\nConstrói com escolhas certas, repetidas todos os dias.",
      "O que parece distante hoje, fica perto quando você começa a caminhar na direção certa.",
    ],
    "Sobre consórcio e patrimônio": [
      "Consórcio não compete com financiamento.\n\nEle compete com a sua paciência — e recompensa quem tem estratégia.",
      "Todo patrimônio sólido tem uma coisa em comum:\n\nfoi construído com planejamento, não com pressa.",
      "Quem entende consórcio, entende que tempo bem usado vale mais que juros altos.",
    ],
    "Mitos sobre consórcio": [
      "Consórcio não é loteria.\n\nÉ planejamento com regras claras — e quem entende as regras, ganha.",
      "Você não “pode não ser sorteado”.\n\nVocê pode dar lances, antecipar, estrategizar. Consórcio é decisão, não sorte.",
      "Achar que consórcio é lento é não conhecer as estratégias certas para acelerar.",
    ],
    "Disciplina financeira": [
      "Disciplina financeira não é sobre abrir mão de tudo.\n\nÉ sobre escolher o que realmente importa pra você.",
      "Toda parcela paga com consciência é um passo a menos até o seu objetivo.",
      "Quem organiza o dinheiro, organiza o futuro.",
    ],
    "Chamada para simulação": [
      "Seu plano ideal pode estar a uma simulação de distância.\n\nVamos descobrir juntos qual é o seu caminho?",
      "Antes de desistir da ideia do imóvel próprio, simule.\n\nPode ser mais simples do que você imagina.",
      "Toda jornada de patrimônio começa com uma pergunta simples: qual é o seu plano? Simule agora.",
    ],
  };
  const opcoes = banco[tema] || banco["Motivacional sobre conquistas"];
  return opcoes[Math.floor(Math.random() * opcoes.length)];
}

export default function App() {
  const [texto, setTexto] = useState(FRASES[0].texto);
  const [legenda, setLegenda] = useState(FRASES[0].legenda);
  const [imgSrc, setImgSrc] = useState(null);
  const [tema, setTema] = useState(TEMAS_IA[0]);
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.card}>
        <div>
          <span style={s.label}>Gerar frase com IA por assunto</span>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 10 }}>
            {TEMAS_IA.map((t, i) => (
              <button key={i} onClick={() => setTema(t)}
                style={{ background: tema === t ? "#111" : "#f0f0f0", color: tema === t ? "#fff" : "#555", border: "none", borderRadius: 20, padding: "6px 13px", fontSize: "0.75rem", cursor: "pointer", fontFamily: "inherit", fontWeight: tema === t ? 700 : 400 }}>
                {t}
              </button>
            ))}
          </div>
          <button onClick={() => { setTexto(gerarFraseIA(tema)); setLegenda("Mais um pensamento sobre construir patrimônio com estratégia. 💭\n\nSe quiser entender como o consórcio pode fazer parte do seu plano, me chama no WhatsApp. 📲\n\n#consorcio #planejamentofinanceiro #patrimonio #investimento"); setImgSrc(null); }}
        ...
        <div>
          <span style={s.label}>Ou escolha uma frase pronta</span>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {FRASES.map((f, i) => (
              <button key={i} onClick={() => { setTexto(f.texto); setLegenda(f.legenda); setImgSrc(null); }}
                style={{ background: texto === f.texto ? "#111" : "#f0f0f0", color: texto === f.texto ? "#fff" : "#555", border: "none", borderRadius: 20, padding: "6px 13px", fontSize: "0.75rem", cursor: "pointer", fontFamily: "inherit", fontWeight: texto === f.texto ? 700 : 400 }}>
                {f.label}
              </button>
            ))}
          </div>
        ...
        <div>
          <span style={s.label}>Ou escreva/edite seu texto</span>
          <textarea value={texto} onChange={e => { setTexto(e.target.value); setImgSrc(null); }} rows={4}
