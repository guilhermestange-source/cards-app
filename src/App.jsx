    ...
    <div style={s.page}>
      ...
      <div style={s.card}>
        <div>
          ...
          <button onClick={() => { setTexto(gerarFraseIA(tema)); setImgSrc(null); }}
        ...
        <div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {FRASES.map((f, i) => (
              <button key={i} onClick={() => { setTexto(f.texto); setImgSrc(null); }}
